...
echo ""
echo "  Reconciling any running LibreChat container..."
bash "$SCRIPT_DIR/reconcile-demo-runtime.sh"
echo ""
echo "  Run 'docker compose up -d' to start any services that are not already running."
echo ""
